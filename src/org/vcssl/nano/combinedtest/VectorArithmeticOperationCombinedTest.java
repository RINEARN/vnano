...
public class VectorArithmeticOperationCombinedTest extends CombinedTestElement {
	...
	private static String vectorDeclIntA = "int a[3]; a[0]=10; a[1]=50; a[2]=30; ";
	private static String vectorDeclIntB = "int b[3]; b[0]=5; b[1]=50; b[2]=10; ";
	private static String vectorDeclIntC = "int c[3]; c[0]=2; c[1]=20; c[2]=32; ";
	private static String vectorDeclIntD = "int d[3]; d[0]=1; d[1]=2; d[2]=3; ";
	private static String vectorDeclFloatA = "float a[3]; a[0]=2.2; a[1]=1.4; a[2]=8.2; ";
	private static String vectorDeclFloatB = "float b[3]; b[0]=4.25; b[1]=2.8; b[2]=12.8; ";
	private static String vectorDeclFloatC = "float c[3]; c[0]=1.125; c[1]=32.4; c[2]=22.8; ";
	private static String vectorDeclFloatD = "float d[3]; d[0]=0.5; d[1]=64.2; d[2]=256.125; ";
	private static String vectorDeclStringA = "string a[3]; a[0]=\"abc\"; a[1]=\"def\"; a[2]=\"ghi\"; ";
	private static String vectorDeclStringB = "string b[3]; b[0]=\"aiueo\"; b[1]=\"kakikukeko\"; b[2]=\"sasisuseso\"; ";
	private static String vectorDeclStringC = "string c[3]; c[0]=\"NaCl\"; c[1]=\"H2O\"; c[2]=\"CaCO3\"; ";
	private static String vectorDeclStringD = "string d[3]; d[0]=\"Si\"; d[1]=\"Ni\"; d[2]=\"Al\"; ";
	...
	private void testAdditions() throws VnanoException {
		...
		scriptCode = vectorDeclIntA + vectorDeclIntB + " a + b ; ";
		...
		scriptCode = vectorDeclIntA + vectorDeclFloatB + " a + b ; ";
		...
		scriptCode = vectorDeclIntA + vectorDeclStringB + " a + b ; ";
	...
	private void testDualOperations() throws VnanoException {
		...
		scriptCode = vectorDeclIntA + vectorDeclIntB + vectorDeclIntC + " a + b + c; ";
		resultL = (long[])this.engine.executeScript(scriptCode);
		...
		scriptCode = vectorDeclFloatA + vectorDeclFloatB + vectorDeclFloatC + " a + b + c; ";
		resultD = (double[])this.engine.executeScript(scriptCode);
		...
		scriptCode = vectorDeclStringA + vectorDeclStringB + vectorDeclStringC + " a + b + c; ";
		resultS = (String[])this.engine.executeScript(scriptCode);
		...
		scriptCode = vectorDeclFloatA + vectorDeclIntB + vectorDeclIntC + " a + b + c; ";
		resultD = (double[])this.engine.executeScript(scriptCode);
		expectedD = new double[]{ 2.2d+5l+2l, 1.4d+50l+20l, 8.2d+10l+32l };
		super.evaluateResult(resultD, expectedD, "float[] + int[] + int[]", scriptCode);

		scriptCode = vectorDeclIntA + vectorDeclFloatB + vectorDeclIntC + " a + b + c; ";
		resultD = (double[])this.engine.executeScript(scriptCode);
		...
		scriptCode = vectorDeclIntA + vectorDeclIntB + vectorDeclFloatC + " a + b + c; ";
		resultD = (double[])this.engine.executeScript(scriptCode);
		...
		scriptCode = vectorDeclIntA + vectorDeclFloatB + vectorDeclFloatC + " a + b + c; ";
		resultD = (double[])this.engine.executeScript(scriptCode);
		...
		scriptCode = vectorDeclFloatA + vectorDeclIntB + vectorDeclFloatC + " a + b + c; ";
		resultD = (double[])this.engine.executeScript(scriptCode);
		...
		scriptCode = vectorDeclFloatA + vectorDeclFloatB + vectorDeclIntC + " a + b + c; ";
		resultD = (double[])this.engine.executeScript(scriptCode);
		...
		scriptCode = vectorDeclStringA + vectorDeclIntB + vectorDeclStringC + " a + b + c; ";
		resultS = (String[])this.engine.executeScript(scriptCode);
		...
		scriptCode = vectorDeclStringA + vectorDeclFloatB + vectorDeclStringC + " a + b + c; ";
		resultS = (String[])this.engine.executeScript(scriptCode);
	...
	private void testTripleOperations() throws VnanoException {
		...
		scriptCode = vectorDeclIntA + vectorDeclIntB + vectorDeclIntC + vectorDeclIntD + " a + b + c + d; ";
		resultL = (long[])this.engine.executeScript(scriptCode);
		...
		scriptCode = vectorDeclFloatA + vectorDeclFloatB + vectorDeclFloatC + vectorDeclFloatD + " a + b + c + d; ";
		resultD = (double[])this.engine.executeScript(scriptCode);
		...
		scriptCode = vectorDeclStringA + vectorDeclStringB + vectorDeclStringC + vectorDeclStringD + " a + b + c + d; ";
		resultS = (String[])this.engine.executeScript(scriptCode);
		...
		scriptCode = vectorDeclIntA + vectorDeclFloatB + vectorDeclIntC + vectorDeclFloatD + " a * b - c / d; ";
		resultD = (double[])this.engine.executeScript(scriptCode);
		...
		scriptCode = vectorDeclFloatA + vectorDeclIntB + vectorDeclFloatC + vectorDeclIntD + " a + b + c + d; ";
		resultD = (double[])this.engine.executeScript(scriptCode);
		...
		scriptCode = vectorDeclStringA + vectorDeclIntB + vectorDeclStringC + vectorDeclIntD + " a + b + c + d; ";
		resultS = (String[])this.engine.executeScript(scriptCode);
		...
		scriptCode = vectorDeclStringA + vectorDeclFloatB + vectorDeclStringC + vectorDeclFloatD + " a + b + c + d; ";
		resultS = (String[])this.engine.executeScript(scriptCode);
	...
	private void testVectorScalarMixedOperations() throws VnanoException {
		...
		scriptCode = vectorDeclIntA + vectorDeclIntB + vectorDeclIntC + vectorDeclIntD + " 123 + b + c + d; ";
		resultL = (long[])this.engine.executeScript(scriptCode);
		expectedL = new long[]{ 123l+5l+2l+1l, 123l+50l+20l+2l, 123l+10l+32l+3l };
		super.evaluateResult(resultL, expectedL, "int + int[] + int[] + int[]", scriptCode);

		scriptCode = vectorDeclIntA + vectorDeclIntB + vectorDeclIntC + vectorDeclIntD + " a + 123 + c + d; ";
		resultL = (long[])this.engine.executeScript(scriptCode);
		expectedL = new long[]{ 10l+123l+2l+1l, 50l+123l+20l+2l, 30l+123l+32l+3l };
		super.evaluateResult(resultL, expectedL, "int[] + int + int[] + int[]", scriptCode);

		scriptCode = vectorDeclIntA + vectorDeclIntB + vectorDeclIntC + vectorDeclIntD + " a + b + 123 + d; ";
		resultL = (long[])this.engine.executeScript(scriptCode);
		expectedL = new long[]{ 10l+5l+123l+1l, 50l+50l+123l+2l, 30l+10l+123l+3l };
		super.evaluateResult(resultL, expectedL, "int[] + int[] + int + int[]", scriptCode);

		scriptCode = vectorDeclIntA + vectorDeclIntB + vectorDeclIntC + vectorDeclIntD + " a + b + c + 123; ";
		resultL = (long[])this.engine.executeScript(scriptCode);
		expectedL = new long[]{ 10l+5l+2l+123l, 50l+50l+20l+123l, 30l+10l+32l+123l };
		super.evaluateResult(resultL, expectedL, "int[] + int[] + int[] + int", scriptCode);

		scriptCode = vectorDeclIntA + vectorDeclIntB + vectorDeclIntC + vectorDeclIntD + " 123 + 456 + c + d; ";
		resultL = (long[])this.engine.executeScript(scriptCode);
		expectedL = new long[]{ 123l+456l+2l+1l, 123l+456l+20l+2l, 123l+456l+32l+3l };
		super.evaluateResult(resultL, expectedL, "int + int + int[] + int[]", scriptCode);

		scriptCode = vectorDeclIntA + vectorDeclIntB + vectorDeclIntC + vectorDeclIntD + " 123 + b + 456 + d; ";
		resultL = (long[])this.engine.executeScript(scriptCode);
		expectedL = new long[]{ 123l+5l+456l+1l, 123l+50l+456l+2l, 123l+10l+456l+3l };
		super.evaluateResult(resultL, expectedL, "int + int[] + int + int[]", scriptCode);

		scriptCode = vectorDeclIntA + vectorDeclIntB + vectorDeclIntC + vectorDeclIntD + " 123 + b + c + 456; ";
		resultL = (long[])this.engine.executeScript(scriptCode);
		expectedL = new long[]{ 123l+5l+2l+456l, 123l+50l+20l+456l, 123l+10l+32l+456l };
		super.evaluateResult(resultL, expectedL, "int + int[] + int[] + int", scriptCode);

		scriptCode = vectorDeclIntA + vectorDeclIntB + vectorDeclIntC + vectorDeclIntD + " a + 123 + 456 + d; ";
		resultL = (long[])this.engine.executeScript(scriptCode);
		expectedL = new long[]{ 10l+123l+456l+1l, 50l+123l+456l+2l, 30l+123l+456l+3l };
		super.evaluateResult(resultL, expectedL, "int[] + int + int + int[]", scriptCode);

		scriptCode = vectorDeclIntA + vectorDeclIntB + vectorDeclIntC + vectorDeclIntD + " a + 123 + c + 456; ";
		resultL = (long[])this.engine.executeScript(scriptCode);
		expectedL = new long[]{ 10l+123l+2l+456l, 50l+123l+20l+456l, 30l+123l+32l+456l };
		super.evaluateResult(resultL, expectedL, "int[] + int + int[] + int", scriptCode);

		scriptCode = vectorDeclIntA + vectorDeclIntB + vectorDeclIntC + vectorDeclIntD + " a + 123 + 456 + 789; ";
		resultL = (long[])this.engine.executeScript(scriptCode);
		expectedL = new long[]{ 10l+123l+456l+789l, 50l+123l+456l+789l, 30l+123l+456l+789l };
		super.evaluateResult(resultL, expectedL, "int[] + int + int + int", scriptCode);

		scriptCode = vectorDeclIntA + vectorDeclIntB + vectorDeclIntC + vectorDeclIntD + " 123 + 456 + 789 + d; ";
		resultL = (long[])this.engine.executeScript(scriptCode);
		expectedL = new long[]{ 123l+456l+789l+1l, 123l+456l+789l+2l, 123l+456l+789l+3l };
		super.evaluateResult(resultL, expectedL, "int + int + int + int[]", scriptCode);


		scriptCode = vectorDeclFloatA + vectorDeclFloatB + vectorDeclFloatC + vectorDeclFloatD + " 1.23 + b + c + d; ";
		resultD = (double[])this.engine.executeScript(scriptCode);
		expectedD = new double[]{ 1.23d+4.25d+1.125d+0.5d, 1.23d+2.8d+32.4d+64.2d, 1.23d+12.8d+22.8d+256.125d };
		super.evaluateResult(resultD, expectedD, "float + float[] + float[] + float[]", scriptCode);

		scriptCode = vectorDeclFloatA + vectorDeclFloatB + vectorDeclFloatC + vectorDeclFloatD + " a + 1.23 + c + d; ";
		resultD = (double[])this.engine.executeScript(scriptCode);
		expectedD = new double[]{ 2.2d+1.23d+1.125d+0.5d, 1.4d+1.23d+32.4d+64.2d, 8.2d+1.23d+22.8d+256.125d };
		super.evaluateResult(resultD, expectedD, "float[] + float + float[] + float[]", scriptCode);

		scriptCode = vectorDeclFloatA + vectorDeclFloatB + vectorDeclFloatC + vectorDeclFloatD + " a + b + 1.23 + d; ";
		resultD = (double[])this.engine.executeScript(scriptCode);
		expectedD = new double[]{ 2.2d+4.25d+1.23d+0.5d, 1.4d+2.8d+1.23d+64.2d, 8.2d+12.8d+1.23d+256.125d };
		super.evaluateResult(resultD, expectedD, "float[] + float[] + float + float[]", scriptCode);

		scriptCode = vectorDeclFloatA + vectorDeclFloatB + vectorDeclFloatC + vectorDeclFloatD + " a + b + c + 1.23; ";
		resultD = (double[])this.engine.executeScript(scriptCode);
		expectedD = new double[]{ 2.2d+4.25d+1.125+1.23d, 1.4d+2.8d+32.4d+1.23d, 8.2d+12.8d+22.8d+1.23d };
		super.evaluateResult(resultD, expectedD, "float[] + float[] + float[] + float", scriptCode);

		scriptCode = vectorDeclFloatA + vectorDeclFloatB + vectorDeclFloatC + vectorDeclFloatD + " 1.23 + 4.56 + c + d; ";
		resultD = (double[])this.engine.executeScript(scriptCode);
		expectedD = new double[]{ 1.23d+4.56d+1.125d+0.5d, 1.23d+4.56d+32.4d+64.2d, 1.23d+4.56d+22.8d+256.125d };
		super.evaluateResult(resultD, expectedD, "float + float + float[] + float[]", scriptCode);

		scriptCode = vectorDeclFloatA + vectorDeclFloatB + vectorDeclFloatC + vectorDeclFloatD + " 1.23 + b + 4.56 + d; ";
		resultD = (double[])this.engine.executeScript(scriptCode);
		expectedD = new double[]{ 1.23d+4.25d+4.56d+0.5d, 1.23d+2.8d+4.56d+64.2d, 1.23d+12.8d+4.56d+256.125d };
		super.evaluateResult(resultD, expectedD, "float + float[] + float + float[]", scriptCode);

		scriptCode = vectorDeclFloatA + vectorDeclFloatB + vectorDeclFloatC + vectorDeclFloatD + " 1.23 + b + c + 4.56; ";
		resultD = (double[])this.engine.executeScript(scriptCode);
		expectedD = new double[]{ 1.23d+4.25d+1.125d+4.56, 1.23d+2.8d+32.4d+4.56d, 1.23d+12.8d+22.8d+4.56d };
		super.evaluateResult(resultD, expectedD, "float + float[] + float[] + float", scriptCode);

		scriptCode = vectorDeclFloatA + vectorDeclFloatB + vectorDeclFloatC + vectorDeclFloatD + " a + 1.23 + 4.56 + d; ";
		resultD = (double[])this.engine.executeScript(scriptCode);
		expectedD = new double[]{ 2.2d+1.23d+4.56d+0.5d, 1.4d+1.23d+4.56d+64.2d, 8.2d+1.23d+4.56d+256.125d };
		super.evaluateResult(resultD, expectedD, "float[] + float + float + float[]", scriptCode);

		scriptCode = vectorDeclFloatA + vectorDeclFloatB + vectorDeclFloatC + vectorDeclFloatD + " a + 1.23 + c + 4.56; ";
		resultD = (double[])this.engine.executeScript(scriptCode);
		expectedD = new double[]{ 2.2d+1.23d+1.125d+4.56d, 1.4d+1.23d+32.4d+4.56d, 8.2d+1.23d+22.8d+4.56 };
		super.evaluateResult(resultD, expectedD, "float[] + float + float[] + float", scriptCode);

		scriptCode = vectorDeclFloatA + vectorDeclFloatB + vectorDeclFloatC + vectorDeclFloatD + " a + 1.23 + 4.56 + 7.89; ";
		resultD = (double[])this.engine.executeScript(scriptCode);
		expectedD = new double[]{ 2.2d+1.23d+4.56d+7.89d, 1.4d+1.23d+4.56d+7.89d, 8.2d+1.23d+4.56d+7.89d };
		super.evaluateResult(resultD, expectedD, "float[] + float + float + float", scriptCode);

		scriptCode = vectorDeclFloatA + vectorDeclFloatB + vectorDeclFloatC + vectorDeclFloatD + " 1.23 + 4.56 + 7.89 + d; ";
		resultD = (double[])this.engine.executeScript(scriptCode);
		expectedD = new double[]{ 1.23d+4.56d+7.89d+0.5d, 1.23d+4.56d+7.89d+64.2d, 1.23d+4.56d+7.89d+256.125d };
		super.evaluateResult(resultD, expectedD, "float + float + float + float[]", scriptCode);


		scriptCode = vectorDeclStringA + vectorDeclStringB + vectorDeclStringC + vectorDeclStringD + " \"x\" + b + c + d; ";
		resultS = (String[])this.engine.executeScript(scriptCode);
		expectedS = new String[]{ "x"+"aiueo"+"NaCl"+"Si", "x"+"kakikukeko"+"H2O"+"Ni", "x"+"sasisuseso"+"CaCO3"+"Al" };
		super.evaluateResult(resultS, expectedS, "string + string[] + string[] + string[]", scriptCode);

		scriptCode = vectorDeclStringA + vectorDeclStringB + vectorDeclStringC + vectorDeclStringD + " a + \"x\" + c + d; ";
		resultS = (String[])this.engine.executeScript(scriptCode);
		expectedS = new String[]{ "abc"+"x"+"NaCl"+"Si", "def"+"x"+"H2O"+"Ni", "ghi"+"x"+"CaCO3"+"Al" };
		super.evaluateResult(resultS, expectedS, "string[] + string + string[] + string[]", scriptCode);

		scriptCode = vectorDeclStringA + vectorDeclStringB + vectorDeclStringC + vectorDeclStringD + " a + b + \"x\" + d; ";
		resultS = (String[])this.engine.executeScript(scriptCode);
		expectedS = new String[]{ "abc"+"aiueo"+"x"+"Si", "def"+"kakikukeko"+"x"+"Ni", "ghi"+"sasisuseso"+"x"+"Al" };
		super.evaluateResult(resultS, expectedS, "string[] + string[] + string + string[]", scriptCode);

		scriptCode = vectorDeclStringA + vectorDeclStringB + vectorDeclStringC + vectorDeclStringD + " a + b + c + \"x\"; ";
		resultS = (String[])this.engine.executeScript(scriptCode);
		expectedS = new String[]{ "abc"+"aiueo"+"NaCl"+"x", "def"+"kakikukeko"+"H2O"+"x", "ghi"+"sasisuseso"+"CaCO3"+"x" };
		super.evaluateResult(resultS, expectedS, "string[] + string[] + string[] + string", scriptCode);

		scriptCode = vectorDeclStringA + vectorDeclStringB + vectorDeclStringC + vectorDeclStringD + " \"x\" + \"y\" + c + d; ";
		resultS = (String[])this.engine.executeScript(scriptCode);
		expectedS = new String[]{ "x"+"y"+"NaCl"+"Si", "x"+"y"+"H2O"+"Ni", "x"+"y"+"CaCO3"+"Al" };
		super.evaluateResult(resultS, expectedS, "string + string + string[] + string[]", scriptCode);

		scriptCode = vectorDeclStringA + vectorDeclStringB + vectorDeclStringC + vectorDeclStringD + " \"x\" + b + \"y\" + d; ";
		resultS = (String[])this.engine.executeScript(scriptCode);
		expectedS = new String[]{ "x"+"aiueo"+"y"+"Si", "x"+"kakikukeko"+"y"+"Ni", "x"+"sasisuseso"+"y"+"Al" };
		super.evaluateResult(resultS, expectedS, "string + string[] + string + string[]", scriptCode);

		scriptCode = vectorDeclStringA + vectorDeclStringB + vectorDeclStringC + vectorDeclStringD + " \"x\" + b + c + \"y\"; ";
		resultS = (String[])this.engine.executeScript(scriptCode);
		expectedS = new String[]{ "x"+"aiueo"+"NaCl"+"y", "x"+"kakikukeko"+"H2O"+"y", "x"+"sasisuseso"+"CaCO3"+"y" };
		super.evaluateResult(resultS, expectedS, "string + string[] + string[] + string", scriptCode);

		scriptCode = vectorDeclStringA + vectorDeclStringB + vectorDeclStringC + vectorDeclStringD + " a + \"x\" + \"y\" + d; ";
		resultS = (String[])this.engine.executeScript(scriptCode);
		expectedS = new String[]{ "abc"+"x"+"y"+"Si", "def"+"x"+"y"+"Ni", "ghi"+"x"+"y"+"Al" };
		super.evaluateResult(resultS, expectedS, "string[] + string + string + string[]", scriptCode);

		scriptCode = vectorDeclStringA + vectorDeclStringB + vectorDeclStringC + vectorDeclStringD + " a + \"x\" + c + \"y\"; ";
		resultS = (String[])this.engine.executeScript(scriptCode);
		expectedS = new String[]{ "abc"+"x"+"NaCl"+"y", "def"+"x"+"H2O"+"y", "ghi"+"x"+"CaCO3"+"y" };
		super.evaluateResult(resultS, expectedS, "string[] + string + string[] + string", scriptCode);

		scriptCode = vectorDeclStringA + vectorDeclStringB + vectorDeclStringC + vectorDeclStringD + " a + \"x\" + \"y\" + \"z\"; ";
		resultS = (String[])this.engine.executeScript(scriptCode);
		expectedS = new String[]{ "abc"+"x"+"y"+"z", "def"+"x"+"y"+"z", "ghi"+"x"+"y"+"z" };
		super.evaluateResult(resultS, expectedS, "string[] + string + string + string", scriptCode);

		scriptCode = vectorDeclStringA + vectorDeclStringB + vectorDeclStringC + vectorDeclStringD + " \"x\" + \"y\" + \"z\" + d; ";
		resultS = (String[])this.engine.executeScript(scriptCode);
