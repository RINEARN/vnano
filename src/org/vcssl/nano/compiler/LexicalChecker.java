...
public class LexicalChecker {
	...
	/**
	 * <span class="lang-en">
	 * Create a new lexical checker with the specified language specification settings
	 * </span>
	 * <span class="lang-ja">
	 * 指定された言語仕様設定で, レキシカルチェッカーを生成します
	 * </span>
	 * .
	 * @param langSpec
	 ...
	 */
	public LexicalChecker(LanguageSpecContainer langSpec) {
