...
public class Int64ScalarSubscriptUnit extends AcceleratorExecutionUnit {
		...
		switch (instruction.getOperationCode()) {
			case ELEM : {
				...
				if (targetArrayRank == 1) {
					...
					node = new Int64ScalarElem1DNode(
				...
				// 2次元配列場合
					...
					node = new Int64ScalarElem2DNode(
						(DataContainer<long[]>)operandContainers[0], (DataContainer<long[]>)operandContainers[1],
				...
				// 3次元配列場合
					...
					node = new Int64ScalarElem3DNode(
						(DataContainer<long[]>)operandContainers[0], (DataContainer<long[]>)operandContainers[1],
						(DataContainer<long[]>)operandContainers[2], (DataContainer<long[]>)operandContainers[3],
	...
	private final class Int64ScalarElem1DNode extends AcceleratorExecutionNode {
	...
	private final class Int64ScalarElem2DNode extends AcceleratorExecutionNode {
	...
	private final class Int64ScalarElem3DNode extends AcceleratorExecutionNode {
