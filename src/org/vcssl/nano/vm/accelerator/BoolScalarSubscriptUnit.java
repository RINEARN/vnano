...
public class BoolScalarSubscriptUnit extends AcceleratorExecutionUnit {
		...
		switch (instruction.getOperationCode()) {
			...
			case REFELM : {
				...
				// 2次元配列の場合
					...
					node = new BoolScalarRefelm2DNode(
						(DataContainer<boolean[]>)operandContainers[0], (DataContainer<boolean[]>)operandContainers[1],
						(DataContainer<long[]>)operandContainers[2], (DataContainer<long[]>)operandContainers[3],
						synchronizer, nextNode
					);
				...
				// 3次元配列の場合
					...
					node = new BoolScalarRefelm3DNode(
						(DataContainer<boolean[]>)operandContainers[0], (DataContainer<boolean[]>)operandContainers[1],
						(DataContainer<long[]>)operandContainers[2], (DataContainer<long[]>)operandContainers[3],
						(DataContainer<long[]>)operandContainers[4], synchronizer, nextNode
					);
	...
	private final class BoolScalarMovelm1DNode extends AcceleratorExecutionNode {
		...
		protected final Boolx1Int64x1ScalarCacheSynchronizer synchronizer; // destとindex部のみ対象 (srcは配列なので)

		public BoolScalarMovelm1DNode(
				DataContainer<boolean[]> dest, DataContainer<boolean[]> src, DataContainer<long[]> index0,
				Boolx1Int64x1ScalarCacheSynchronizer synchronizer, AcceleratorExecutionNode nextNode) {
	...
	private final class BoolScalarMovelm2DNode extends AcceleratorExecutionNode {

		protected final DataContainer<boolean[]> dest;
		protected final DataContainer<boolean[]> src;
		protected final DataContainer<long[]> index0;
		protected final DataContainer<long[]> index1;
		protected final Boolx1Int64x2ScalarCacheSynchronizer synchronizer; // destとindex部のみ対象 (srcは配列なので)

		public BoolScalarMovelm2DNode(
	...
	private final class BoolScalarMovelm3DNode extends AcceleratorExecutionNode {
		...
		protected final Boolx1Int64x3ScalarCacheSynchronizer synchronizer; // destとindex部のみ対象 (srcは配列なので)

		public BoolScalarMovelm3DNode(
				DataContainer<boolean[]> dest, DataContainer<boolean[]> src,
				DataContainer<long[]> index0, DataContainer<long[]> index1, DataContainer<long[]> index2,
				Boolx1Int64x3ScalarCacheSynchronizer synchronizer, AcceleratorExecutionNode nextNode) {
	...
	private final class BoolScalarRefelm1DNode extends AcceleratorExecutionNode {
	...
	private final class BoolScalarRefelm2DNode extends AcceleratorExecutionNode {
	...
	private final class BoolScalarRefelm3DNode extends AcceleratorExecutionNode {
