...
public class Int64CachedScalarSubscriptUnit extends AcceleratorExecutionUnit {
	...
	public AcceleratorExecutionNode generateNode(
		...
		switch (instruction.getOperationCode()) {
			case ELEM : {
				...
				node = new Int64CachedScalarElem1DNode(
	...
	private final class Int64CachedScalarElem1DNode extends AcceleratorExecutionNode {
		...
		public Int64CachedScalarElem1DNode(
